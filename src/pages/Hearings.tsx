    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-white shadow-sm h-16 flex items-center justify-between px-8 border-b border-gray-200">
          <h1 className="text-xl font-semibold text-legal-corporate">Global Hearings</h1>
        ...
        <main className="p-8">
          {isLoading && (
            <div className="mb-6 p-4 bg-white border border-gray-100 text-gray-600 rounded-xl">
              Loading hearings...
            </div>
          )}
          {error && (
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <button 
                ...
                className="text-sm font-bold text-legal-corporate hover:text-legal-gold transition-colors"
              >
                Clear All Filters
              </button>
            </div>
